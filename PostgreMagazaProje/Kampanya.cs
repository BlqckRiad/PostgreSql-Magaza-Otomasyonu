...
namespace PostgreMagazaProje
{
    public partial class Kampanya : Form
    {
        ...
        {
            String sorgu = "select kampanya.kampanyaid,urunad,urunstok,urunsatis,kampanya.kampanyaindirimoranı,kampanyalı(kampanya.kampanyaindirimoranı,urunler.urunsatis) from urunler inner join kampanya on urunler.urunid=kampanya.kampanyalıurunid";
        ...
        {
            String sorgu2 = "\r\nselect urunid,urunad,urunstok,urunsatis,kategori.kategoriad,beden.bedenad,ürüngaranti.garantisüre from urunler\r\ninner join kategori\r\non\r\nkategori.kategoriid = urunler.urunkategori\r\ninner join beden\r\non\r\nbeden.bedenid = urunler.urunbeden\r\ninner join ürüngaranti \r\non\r\nurunler.urunsigorta = ürüngaranti.garantiid";
