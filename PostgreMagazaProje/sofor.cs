...
namespace PostgreMagazaProje
{
    public partial class sofor : Form
    {
        ...
        {
            String sorgu = "select \r\n\"Calisan\".\"Calisan\".\"calisanNo\",\r\n\"Calisan\".\"Calisan\".\"adi\",\r\n\"Calisan\".\"Calisan\".\"soyadi\",\r\n\"Calisan\".\"Calisan\".\"calisanYas\",\r\n\"Calisan\".\"Calisan\".\"calisanDeneyim\",\r\n\"Calisan\".\"Calisan\".\"calisanMaas\",\r\n\"Calisan\".\"Sürücü\".\"SürücüTipi\",\r\nArac.aracıd,\r\nArac.aracmarka,\r\nArac.aracmodelyılı,\r\nArac.aractedarikciid\r\nfrom \"Calisan\".\"Calisan\"\r\ninner join\r\n\"Calisan\".\"Sürücü\"\r\non\r\n\"Calisan\".\"Calisan\".\"calisanNo\" = \"Calisan\".\"Sürücü\".\"calisanNo\"\r\ninner join\r\nArac\r\non\r\n\"Calisan\".\"Sürücü\".\"SürücüAracID\" = Arac.aracıd";
