...
namespace PostgreMagazaProje
{
    public partial class Arac : Form
    {
        ...
        NpgsqlConnection baglanti = new NpgsqlConnection("server=localHost;port=5432;Database=dbmagaza;user ID=postgres; password=enes3636");
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into arac(aracıd,aracmarka,aracmodelyılı,aractedarikciid) values (@p1,@p2,@p3,@p4)", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("delete from arac where aracıd=@p1", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut5 = new NpgsqlCommand("select * from arac where aracıd=@p1", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut3 = new NpgsqlCommand("update arac set aracmarka=@p1,aracmodelyılı=@p2,aractedarikciid=@p3  where aracıd=@p4", baglanti);
