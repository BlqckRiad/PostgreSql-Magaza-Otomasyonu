...
namespace PostgreMagazaProje
{
    public partial class Form1 : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into urunler(urunid,urunad,urunstok,urunalis,urunsatis,urunkategori,uruntedarikci,urunbeden,urunsigorta) values (@p1,@p2,@p3,@p4,@p5,@p6,@p7,@p8,@p9)", baglanti);
